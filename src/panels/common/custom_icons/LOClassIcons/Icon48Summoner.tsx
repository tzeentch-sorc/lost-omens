...
const Icon48Summoner = (props: SvgIconProps) => (
  <SvgIcon width={48} height={48} viewBox="0 0 256 256" strokeWidth="0px" {...props}>
    <g>
    <path d="M120.2,150l-19.7-49.9c0,0-2-20.7-3.7-28.4C88.6,36,48.7,3.8,5.8,3.8C4.6,3.8,4,3.8,2,3.9V253h46v-28h15.2
