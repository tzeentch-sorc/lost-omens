...
const RGCharInfoSettings = new QuerySettings({
	...
	query: {
		colByField: { name: 0, rep: 1, humanity: 2, exp: 3, downtime: 4, freetime: 5, budget: 6, income: 7, expenses: 8, drink: 9, helped: 10, hurt: 11, implants: 12 },
		fieldByCol: { 0: "name", 1: "rep", 2: "humanity", 3: "exp", 4: "downtime", 5: "freetime", 6: "budget", 7: "income", 8: "expenses", 9: "drink", 10: "helped", 11: "hurt", 12: "implants" },
